...
venue: "University of Miami - RSMAS"        # brief name of host site without address (e.g., "Euphoric State University")
...
latlng: "25.732846, -80.162627"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Tim Norris", "Kalan Dawson"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Map Room","RSMAS Library"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<div>
  <h2>Registration</h2>
  Make sure to register using this <a href="https://docs.google.com/forms/d/e/1FAIpQLSc42juDq0bwWUhiFMn8HTNDrbCdkwzDvSFcwe4dLDUHENrYeQ/viewform">google form</a> as there are a limited number of seats.
</div>
